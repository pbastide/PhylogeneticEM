...
<!-- It can be shown that an Early Burst model (EB) is formally equivalent on an ultrametric tree to an scOU with a negative alpha value. -->

<!-- ```{r, label="Fit_EM_negative", warning=FALSE} -->

...
By default, the inference is done on an automatically computed grid of alpha values. Here, to keep the computations to a minimum, we will only use $2$ values for alpha, including the true value. 
...
res <- PhyloEM(phylo = tree,
               ...
               method.selection = "BirgeMassart1", ## Model selection criterion

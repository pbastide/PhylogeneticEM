...
saveresultfile = "../Results/Simulations_Several_K/multivariate_estimations_SUN_rBM_"
datestamp_day <- "2016-07-06" # 03-17 11-19 11-24

#simestimations_alpha_known <- NULL
simestimations <- NULL
ak <- "alpha_known_"

files_list <- list.files(pattern = "multivariate_estimations_SUN_rBMalpha_known_2016-07")
